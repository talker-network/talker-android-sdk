...
import network.talker.sdk.TalkerSdk
                            ...
                            putExtra(
                                "ptt_audio", AudioData(
                                    ...
                                    (currentLiveMessage?.group_name ?: "").ifEmpty {
                                        TalkerSdk.database.roomDao().getChannelById(channelId = (currentLiveMessage?.channel_id ?: ""))?.group_name ?: ""
                                    },
                                    (currentLiveMessage?.sender_name ?: "").ifEmpty {
                                        TalkerSdk.database.roomDao().getUserById(
                                            currentLiveMessage?.sender_id ?: ""
                                        )?.name ?: ""
                                    }
                                )
