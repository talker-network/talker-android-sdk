package com.dev.talkersdk.sdk.model
...
class Event(val senderClientId: String, val messageType: String, val messagePayload: String) {
...
//            val s = String(Base64.decode(answerEvent.messagePayload, URL_SAFE or NO_WRAP)).removeSurrounding("\"", "").replace("\\\"", "\"")
//                .replace(
//                    "\\", ""
//                ).replace("rn", "\r\n").dropLast(1)
//            Log.d(
